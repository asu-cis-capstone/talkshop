<!--
TALKSHOP! Login Email Notification for Speakers
-->

<div id="pleaseLoginSpeaker">PLEASE JOIN TALKSHOP TO CONTACT THIS SPEAKER</div>
<div id="pleaseLoginSubText">If you already have an account, please login. Otherwise, click one of the links below to register as a speaker or a teacher.</div>
	...
	<div id="registerTeacherButton" onclick="javascript:location.href='teacherRegistration.php'">
		<div id="teacher">Register as a Teacher</div>
	</div>
