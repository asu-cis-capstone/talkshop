  ...
  <body>
	...
	<div id="searchForm">
		...
		<p id="searchTitle">Search</p>
			...
			<form method="post" action="search/search_display.php?go" id="searchform">
		<input type="text" name="name" class="textFields" placeholder="Search" type="text" id="search" name="search">
...
$sql="SELECT FName, Lname, city, state, zip FROM users WHERE FName LIKE '%" . $name . "%' 
OR Lname LIKE '%" . $name ."%' 
OR city LIKE '%" . $name . "%' 
OR state LIKE '%" . $name . "%'
OR zip LIKE '%" . $name . "%'
...
?>
			...
			<!--<input class="textFields" placeholder="Search" type="text" id="search" name="search">-->
							...
							<!-- This is the styled searchButton-->
							<!--<div id="searchButton" input type="submit" name="submit" value="Search" ">-->
